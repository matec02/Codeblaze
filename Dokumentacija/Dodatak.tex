\chapter*{Dodatak: Prikaz aktivnosti grupe}
		...
		\begin{figure} [H]
			...
			\includegraphics[width=1\linewidth]{slike/Aktivnost1.jpg}
			\centering
			\caption{Prikaz Aktivnosti grupe}
			\label{fig:Prikaz Aktivnosti grupe}
		\end{figure}
		\begin{figure} [H]
			
			\includegraphics[width=1\linewidth]{slike/Aktivnost3.jpg}
			\centering
			\caption{Prikaz Aktivnosti grupe}
			\label{fig:Prikaz Aktivnosti grupe}
		\end{figure}
		\begin{figure} [H]
			...
			\includegraphics[width=1\linewidth]{slike/Aktivnost2.jpg}
			\centering
			\caption{Prikaz Aktivnosti grupe}
			\label{fig:Prikaz Aktivnosti grupe}
		\end{figure}
		...
		\begin{figure} [H]
			...
			\includegraphics[width=1\linewidth]{slike/Aktivnost4.jpg}
			\centering
			\caption{Prikaz Aktivnosti grupe}
			\label{fig:Prikaz Aktivnosti grupe}
		\end{figure}

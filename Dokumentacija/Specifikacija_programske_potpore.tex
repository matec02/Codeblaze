			...
			\subsection{Obrasci uporabe}
				...
				\subsubsection{Opis obrazaca uporabe}
					...
					\end{packed_item}
						...
						\end{packed_item}
						\noindent \underbar{\textbf{UC16 - Pogledaj profil klijenta}}
						\begin{packed_item}
							
							\item \textbf{Glavni sudionik: }Iznajmljivač
							\item  \textbf{Cilj: }Pogledati profil klijenta
							\item  \textbf{Sudionici: }Baza podataka
							\item  \textbf{Preduvjet: }-
							\item  \textbf{Opis osnovnog tijeka:}
							...
							\item[] \begin{packed_enum}
								...
								\item Iznajmljivač pregledava dostupne podatke klijenta te ocjene i komentare drugih iznajmljivača
		 
							\end{packed_enum}
							
							
						\end{packed_item}
						\noindent \underbar{\textbf{UC17 - Prihvati ponudu}}
						\begin{packed_item}
						...
						\end{packed_item}
						\noindent \underbar{\textbf{UC19 - Zamijeni sliku romobila}}
						\begin{packed_item}
							...
							\end{packed_item}
						\end{packed_item}
						\noindent \underbar{\textbf{UC20 - Žali se na zamjenu slike}}
						\begin{packed_item}
						...
						\end{packed_item}
						\noindent \underbar{\textbf{UC21 - Odluči i obavijesti o zamjeni slike}}
						\begin{packed_item}
						...
						\end{packed_item}
						\noindent \underbar{\textbf{UC22 - Vrati romobil}}
						\begin{packed_item}
							...
							\end{packed_item}
						\end{packed_item}
						\noindent \underbar{\textbf{UC23 - Ocijeni klijenta}}
						\begin{packed_item}
						...
						\end{packed_item}
						\noindent \underbar{\textbf{UC24 - Uplati novac banci}}
						\begin{packed_item}
						...
						\end{packed_item}
						\noindent \underbar{\textbf{UC25 - Isplati iznajmljivača}}
						\begin{packed_item}
						...
						\end{packed_item}
						\noindent \underbar{\textbf{UC26 - Dodaj administratora}}
						\begin{packed_item}

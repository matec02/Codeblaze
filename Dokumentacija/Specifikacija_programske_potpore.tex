			...
			\subsection{Obrasci uporabe}
				...
				\subsubsection{Opis obrazaca uporabe}
					...
					\end{packed_item}
						...
						\end{packed_item}
						\noindent \underbar{\textbf{UC13 - Pošalji poruku!!!!}}
						\begin{packed_item}
						...
						\end{packed_item}
						\noindent \underbar{\textbf{UC14 - Iznajmi romobil}}
						\begin{packed_item}
						...
						\end{packed_item}
						\noindent \underbar{\textbf{UC15 - Prihvati ponudu}}
						\begin{packed_item}
							...
							\end{packed_item}
						\end{packed_item}
						\noindent \underbar{\textbf{UC16 - Zamijeni sliku romobila}}
						\begin{packed_item}
							...
							\end{packed_item}
						\end{packed_item}
						\noindent \underbar{\textbf{UC17 - Žali se na zamjenu slike}}
						\begin{packed_item}
						...
						\end{packed_item}
						\noindent \underbar{\textbf{UC18 - Odluči i obavijesti o zamjeni slike}}
						\begin{packed_item}
						...
						\end{packed_item}
						\noindent \underbar{\textbf{UC19 - Vrati romobil}}
						\begin{packed_item}
							...
							\end{packed_item}
						\end{packed_item}
						\noindent \underbar{\textbf{UC20 - Ocijeni klijenta}}
						\begin{packed_item}
							
							\item \textbf{Glavni sudionik: }Iznajmljivač
							\item  \textbf{Cilj: }Ocijeniti klijenta po završetku iznajmljivanja romobila
							\item  \textbf{Sudionici: }Klijent, baza podataka
							\item  \textbf{Preduvjet: }Klijent vratio romobil
							\item  \textbf{Opis osnovnog tijeka:}
						...
						\end{packed_item}
						\noindent \underbar{\textbf{UC21 - Uplati novac banci}}
						\begin{packed_item}
							
							\item \textbf{Glavni sudionik: }Klijent
							\item  \textbf{Cilj: }Uplatiti cijenu iznajmljivanja banci 
							\item  \textbf{Sudionici: }Banka
						...
						\end{packed_item}
						\noindent \underbar{\textbf{UC22 - Isplati iznajmljivača}}
						\begin{packed_item}
						...
						\end{packed_item}
						\noindent \underbar{\textbf{UC23 - Pohrani transakciju}}
						\begin{packed_item}
							
							\item \textbf{Glavni sudionik: }Baza podataka
							\item  \textbf{Cilj: }Dokumentirati plaćanje s računa klijenta na račun iznajmljivača
							\item  \textbf{Sudionici: }-
							\item  \textbf{Preduvjet: }Završeno iznajmljivanje, vraćen romobil
							\item  \textbf{Opis osnovnog tijeka:}
							
							\item[] \begin{packed_enum}
								
								\item Nakon završetka iznajmljivanja obračunava se cijena iznajmljivanja  
								\item Cijena se zajedno s ostalim informacijama o transakciji sprema u bazu podataka 
